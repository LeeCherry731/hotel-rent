        ...
        >
          ...
          <ul className="inline-flex -space-x-px text-sm h-8">
            ...
            <li>
              <p
                aria-current="page"
                className="flex items-center justify-center px-3 h-8 leading-tight text-blue-600 bg-blue-100 border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
              >
                1
              </p>
            </li>
